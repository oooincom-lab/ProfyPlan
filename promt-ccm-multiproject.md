...
**Графики — это виды рабочего поля, а не страницы.** Сеть CPM переносится в рабочую область как вид; адрес `/cpm` остаётся перенаправлением. Единая шкала времени, единые единицы (дни/часы/минуты) и общая легенда на всех видах.
