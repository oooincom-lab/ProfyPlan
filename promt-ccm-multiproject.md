...
3. **Радиус магнита** — 2 дня (настраиваемо; можно задавать в днях и/или часах). Влияет на «липкость»: меньше радиус — точнее ручной контроль, больше — удобнее дальние сдвиги, но «хватает» лишнее.
